...
const ModalSoftskillCreate = ({ handleModalClose }) => {
    ...
    const onSubmit = data => {
        dispatch( Creating( "softskill/", data ) );
    }
            ...
            <form onSubmit={ handleSubmit( onSubmit ) } className={ classes.body }>
                <div id="object">
                    <FormControl className={ classes.margin }>
                        <InputLabel shrink htmlFor="SoftkillName">Softskill Name</InputLabel>
                        <BootstrapInput 
                            name="Softskillname"
                            inputRef={register}
                            placeholder="Softkill Name" />
...
export default ModalSoftskillCreate
