...
const ModalModuleCreate = ({ handleModalClose }) => {
            ...
            <form onSubmit={ handleSubmit( onSubmit ) } className={ classes.body }>
                <div id="object">
                    <FormControl className={ classes.margin }>
                        <InputLabel shrink htmlFor="Modulename">Module Name</InputLabel>
                        <BootstrapInput 
                            name="Modulename"
                            inputRef={register}
...
export default ModalModuleCreate
