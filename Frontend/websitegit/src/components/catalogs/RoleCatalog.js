...
import ModalRoleCreate from './ModalRoleCreate';
...
const RoleCatalog = () => {
    ...
    useEffect(() => {
        dispatch(ChargeData("role/getroles/"));
    }, [dispatch]);
    ...
    const onSubmit = data => {
        console.log(data);
        dispatch(Updating(`role/${data.id}`, data));
        reset();
    }
    const headCells = [
        { id: 'id', numeric: false, disablePadding: true, label: 'ID' },
        { id: 'Rolename', numeric: false, disablePadding: false, label: 'Roles' },
                    ...
                    ? <TableCell align="left">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <TextField
                                inputRef={register}
                                name="Rolename"
                                defaultValue={row.Rolename} size="small" />
                    ...
                    ? <TableCell align="left">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <TextField
                                inputRef={register}
                                name="Leader"
                                defaultValue={row.Leader} size="small" />
                            <FormHelperText className={classes.error}>
                                <ErrorMessage errors={errors} name="Leader" />
                            </FormHelperText>
                        </form>
                    </TableCell>
